...
mod tests {
    ...
    // TODO We might want to cache the results of closures that take a string slice and
    // return usize values, for example. To fix this issue, try introducing more generic
